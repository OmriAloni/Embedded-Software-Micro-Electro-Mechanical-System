...
#define SDA_SERIAL_BAUD2400 2400
#define SDA_SERIAL_BAUD9600 9600
#define SDA_SERIAL_BAUD19200 19200
#define SDA_SERIAL_BAUD38400 38400
...
void InitUARTs(){
	...
	Uart0_Br_Sbr(CORE_CLOCK/2/1000, 115200);
	
	//UART0_C1 |= UART0_C1_PE_MASK | UART0_C1_M_MASK; //even parity bit and 9-bit data (9-th bit is for parity)
	//Enable receive interrupts 
	UART0_C3 |= UARTLP_C3_ORIE_MASK| UARTLP_C3_FEIE_MASK |UARTLP_C3_PEIE_MASK; //Enable overrun,framing and parity interrupt.
...
/********************************************************************
sendACK- send ACK char to PC.
*********************************************************************/

void sendACK(char ack){
 uart_putchar ((UART_MemMapPtr)UART0_BASE_PTR, ack); //ofir: need to checked 
}
